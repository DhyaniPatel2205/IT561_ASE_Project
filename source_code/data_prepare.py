...
def prepare_so_dataset():
    ...
    # Prepare Dataset 
    src_path = "/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/src-train.txt"
    tgt_path = "/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/tgt-train.txt"
    print ("trainset...")
    ...
    src_path = "/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/src-test-clear.txt"
    tgt_path = "/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/tgt-test-clear.txt"
    print ("testset...")
