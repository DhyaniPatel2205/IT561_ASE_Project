...
class Evaluation(object):
    ...
    def write_review(self):
        with open('/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/evaluation_review', "w") as report:
            for e in self.evaluation_report:
                hypothesis, reference, bleu_score, rouge_score = e[0], e[1], e[2], e[3]
                bleu1_score, bleu2_score, bleu3_score, bleu4_score = bleu_score[0], bleu_score[1], bleu_score[2], bleu_score[3]
                report.write(str(hypothesis) + '\t' + str(reference) + '\t' + str(bleu4_score) + '\n')
...
def main():
    ...
    hypo_path = "/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/hypothesis.txt"
    ref_path =  '/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/reference.txt'
    eval_path = "/content/drive/MyDrive/dhyani_code2que_new/data_sample/pydata/evaluation_report"
